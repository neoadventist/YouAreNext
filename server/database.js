...
var visitorsSchema = new Schema({name:{type: String, default: null},position:{type: Number, default: 0},vendorId:{type: String, default: null},in:{type: Date, default: new Date()},out:{type: Date, default: null},position:{type: Number, default: 0},finished:{type: Boolean, default: false}});
